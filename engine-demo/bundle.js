(() => {
  ...
  var require_jquery = __commonJS({
    "node_modules/jquery/dist/jquery.js"(exports, module) {
      (function(global2, factory) {
            ...
            if ((options = arguments[i]) != null) {
              for (name in options) {
                ...
                if (deep && copy && (jQuery3.isPlainObject(copy) || (copyIsArray = Array.isArray(copy)))) {
                  ...
                  copyIsArray = false;
                  target[name] = jQuery3.extend(deep, clone2, copy);
                } else if (copy !== void 0) {
                  target[name] = copy;
                }
              }
        ...
        (function() {
          var i, Expr, outermostContext, sortInput, hasDuplicate, push3 = pushNative, document3, documentElement2, documentIsHTML, rbuggyQSA, matches, expando = jQuery3.expando, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), nonnativeSelectorCache = createCache(), sortOrder = function(a, b) {
            if (a === b) {
              hasDuplicate = true;
            }
            return 0;
          ...
          find2.escape = jQuery3.escapeSelector;
          find2.getText = jQuery3.text;
          find2.isXML = jQuery3.isXMLDoc;
          find2.selectors = jQuery3.expr;
          find2.support = jQuery3.support;
          find2.uniqueSort = jQuery3.uniqueSort;
        })();
        ...
        var rootjQuery, rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, init2 = jQuery3.fn.init = function(selector, context, root2) {
          var match, elem;
          if (!selector) {
            return this;
          }
        ...
        function createOptions(options) {
          var object2 = {};
          jQuery3.each(options.match(rnothtmlwhite) || [], function(_3, flag) {
            object2[flag] = true;
          });
          return object2;
        }
          ...
          var firing, memory, fired, locked, list = [], queue = [], firingIndex = -1, fire = function() {
            ...
            add: function() {
              if (list) {
                ...
                (function add(args) {
                  jQuery3.each(args, function(_3, arg) {
                    if (isFunction2(arg)) {
            ...
            remove: function() {
              jQuery3.each(arguments, function(_3, arg) {
                var index;
        ...
        function adjustCSS(elem, prop, valueParts, tween) {
          ...
          }, initial2 = currentValue(), unit = valueParts && valueParts[3] || (jQuery3.cssNumber[prop] ? "" : "px"), initialInUnit = elem.nodeType && (jQuery3.cssNumber[prop] || unit !== "px" && +initial2) && rcssNum.exec(jQuery3.css(elem, prop));
        ...
        jQuery3.each({
          ...
          jQuery3.fn[name] = function(selector) {
            var elems, ret = [], insert = jQuery3(selector), last2 = insert.length - 1, i = 0;
            for (; i <= last2; i++) {
          ...
          css: function(name, value) {
            return access(this, function(elem, name2, value2) {
              ...
              if (Array.isArray(name2)) {
                ...
                len = name2.length;
                for (; i < len; i++) {
                  map2[name2[i]] = jQuery3.css(elem, name2[i], false, styles);
                }
                return map2;
              }
        ...
        Tween.propHooks = {
          _default: {
            get: function(tween) {
              ...
              result2 = jQuery3.css(tween.elem, tween.prop, "");
        ...
        function Animation(elem, properties, options) {
          var result2, stopped, index = 0, length = Animation.prefilters.length, deferred = jQuery3.Deferred().always(function() {
            delete tick.elem;
          }), tick = function() {
            if (stopped) {
              return false;
          ...
          for (; index < length; index++) {
            ...
            if (result2) {
              if (isFunction2(result2.stop)) {
                jQuery3._queueHooks(animation.elem, animation.opts.queue).stop = result2.stop.bind(result2);
              }
              return result2;
            }
          }
        ...
        jQuery3.extend({
          valHooks: {
            ...
            select: {
              ...
              set: function(elem, value) {
                var optionSet, option, options = elem.options, values2 = jQuery3.makeArray(value), i = options.length;
                while (i--) {
                  option = options[i];
                  if (option.selected = jQuery3.inArray(jQuery3.valHooks.option.get(option), values2) > -1) {
                    optionSet = true;
                  }
                }
                if (!optionSet) {
        ...
        function inspectPrefiltersOrTransports(structure, options, originalOptions, jqXHR) {
          ...
          function inspect(dataType) {
            ...
            jQuery3.each(structure[dataType] || [], function(_3, prefilterOrFactory) {
  ...
  var require_create_svg = __commonJS({
    "src/browser/create-svg.js"(exports, module) {
    ...
    "node_modules/jquery.hotkeys/jquery.hotkeys.js"(exports) {
      (function(jQuery3) {
        ...
        function keyHandler(handleObj) {
          ...
          var origHandler = handleObj.handler, keys2 = handleObj.data.keys.toLowerCase().split(" ");
  ...
  // test/esbuild-shims/jquery-hotkeys-shim.js
    ...
    "src/browser/dom-map-widget.js"() {
      ...
      $.fn.domMapWidget = function(activityLog, mapModel, touchEnabled, dragContainer, centerSelectedNodeOnOrientationChange) {
        ...
        return this.each(function() {
          ...
          _3.each(hotkeyEventHandlers, function(mappedFunction, keysPressed) {
          ...
          $(document).on("keydown", function(e) {
            ...
            if (e && !e.altKey && (e.ctrlKey || e.metaKey)) {
              if (e.originalEvent && e.originalEvent.keyIdentifier) {
                mappedFunction = functions2[e.originalEvent.keyIdentifier];
              } else if (e.key === "MozPrintableKey") {
                mappedFunction = functions2[e.which];
              }
              if (mappedFunction) {
                if (actOnKeys) {
                  e.preventDefault();
  ...
  var require_node_to_box = __commonJS({
    "src/core/layout/node-to-box.js"(exports, module) {
  ...
  // src/core/layout/layout-model.js
  var require_layout_model = __commonJS({
    "src/core/layout/layout-model.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      ...
      module.exports = function LayoutModel(emptyLayout) {
        ...
        const self2 = this, options = {
          ...
          const nodes = layout && _3.values(layout.nodes), filtered = nodes && _3.filter(nodes, predicate);
          ...
          return _3.min(nodes, function(node) {
            const d = [
          ...
          if (self2.getOrientation() === "standard") {
            ...
            if (siblings.length) {
              return _3.min(siblings, (node) => Math.abs(node.y - referenceNode.y));
            }
          }
        ...
        self2.layoutBounds = function() {
          ...
          if (_3.isEmpty(layout.nodes)) {
            return false;
          }
          _3.each(layout.nodes, function(node) {
            if (!minx) {
              minx = node.x;
              miny = node.y;
  ...
  var require_observable = __commonJS({
    "src/core/util/observable.js"(exports, module) {
  ...
  var require_calc_idea_level = __commonJS({
    "src/core/content/calc-idea-level.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      module.exports = function calcIdeaLevel(contentIdea, nodeId, currentLevel) {
        ...
        const directChild = _3.find(contentIdea.ideas, function(idea) {
          return idea.id == nodeId;
        });
        if (directChild) {
          return currentLevel;
        }
        return _3.reduce(contentIdea.ideas, function(result2, idea) {
          return result2 || calcIdeaLevel(idea, nodeId, currentLevel + 1);
        }, void 0);
      };
    }
  });
  ...
  var require_sorted_sub_ideas = __commonJS({
    "src/core/content/sorted-sub-ideas.js"(exports, module) {
  ...
  var require_traverse = __commonJS({
    "src/core/content/traverse.js"(exports, module) {
  ...
  // src/core/content/auto-themed-idea-utils.js
  var require_auto_themed_idea_utils = __commonJS({
    "src/core/content/auto-themed-idea-utils.js"(exports, module) {
  ...
  var require_map_model = __commonJS({
    "src/core/map-model.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      ...
      module.exports = function MapModel(selectAllTitles, defaultReorderMargin, optional) {
        ...
        const self2 = this, autoThemedIdeaUtils = optional && optional.autoThemedIdeaUtils || require_auto_themed_idea_utils(), reorderMargin = optional && optional.reorderMargin || 20, layoutModel = optional && optional.layoutModel || new LayoutModel({ nodes: {}, connectors: {} }), setRootNodePositionsForPrecalculatedLayout = function(contextNode, specificLayout) {
          ...
          const wasActivated = _3.clone(activatedNodes);
          if (activated.length === 0) {
            activatedNodes = [currentlySelectedIdeaId];
          } else {
            activatedNodes = activated;
          }
          self2.dispatchEvent("activatedNodesChanged", _3.difference(activatedNodes, wasActivated), _3.difference(wasActivated, activatedNodes));
        }, applyLabels = function(newLayout) {
          const labelMap = currentLabelGenerator && currentLabelGenerator(idea);
          if (!labelMap) {
            return;
          }
          _3.each(newLayout.nodes, function(node, id) {
            if (labelMap[id] || labelMap[id] === 0) {
              node.label = labelMap[id];
            }
          });
        }, closestNodeId = function(nodeList, referenceNode) {
          const closestNode = _3.min(nodeList, function(node) {
          ...
          self2.dispatchEvent("layoutChangeStarting", _3.size(newLayout.nodes) - _3.size(currentLayout.nodes));
          applyLabels(newLayout);
          _3.each(currentLayout.connectors, function(oldConnector, connectorId) {
          ...
          _3.each(currentLayout.links, function(oldLink, linkId) {
            const newLink = newLayout.links && newLayout.links[linkId];
            if (!newLink) {
              self2.dispatchEvent("linkRemoved", oldLink);
            }
          });
          _3.each(currentLayout.nodes, function(oldNode, nodeId) {
            ...
            if (!newNode) {
              ...
              newActive = _3.reject(activatedNodes, function(e) {
                return e == nodeId;
              });
          ...
          _3.each(newLayout.nodes, function(newNode, nodeId) {
            ...
            if (!oldNode) {
              ...
              if (newNode.width !== oldNode.width || newNode.height !== oldNode.height || newNode.level !== oldNode.level || !_3.isEqual(newNode.attr || {}, oldNode.attr || {}) || themeChanged) {
          ...
          _3.each(newLayout.connectors, function(newConnector, connectorId) {
            const oldConnector = currentLayout.connectors[connectorId];
            if (oldConnector && !_3.isEqual(oldConnector.attr || {}, newConnector.attr || {})) {
          ...
          _3.each(newLayout.links, function(newLink, linkId) {
            const oldLink = currentLayout.links && currentLayout.links[linkId];
            if (oldLink) {
              if (!_3.isEqual(newLink.attr || {}, oldLink && oldLink.attr || {})) {
        ...
        this.collapse = function(source, doCollapse) {
          ...
          if (isInputEnabled) {
            self2.applyToActivated(function(id) {
              const node = self2.findIdeaById(id);
              if (node && (!doCollapse || node.ideas && _3.size(node.ideas) > 0)) {
        ...
        this.updateLinkStyle = function(source, ideaIdFrom, ideaIdTo, prop, value) {
          const merged = _3.extend({}, idea.getLinkAttr(ideaIdFrom, ideaIdTo, "style"));
          if (!isEditingEnabled) {
            return false;
          }
          if (isInputEnabled) {
        ...
        self2.addGroupSubidea = function(source, options) {
          const parentId = options && options.parentId, group2 = options && options.group || true, target = parentId || currentlySelectedIdeaId;
          ...
          if (isInputEnabled) {
            idea.batch(function() {
              ...
              if (newGroupId) {
                ...
                idea.updateAttr(newGroupId, "group", group2);
        ...
        this.insertIntermediateGroup = function(source, options) {
          const activeNodes = [], group2 = options && options.group || true;
          if (!isEditingEnabled) {
            return false;
          }
          ...
          insertIntermediateMultiple(activeNodes, { title: "group", attr: { group: group2, contentLocked: true } });
        };
        ...
        this.editNode = function(source, shouldSelectAll, editingNew) {
          ...
          if (_3.include(selectAllTitles, title)) {
        ...
        this.toggleLink = function(source, nodeIdTo) {
          const exists = _3.find(idea.links, function(link) {
        ...
        self2.contextForNode = function(nodeId) {
          const node = self2.findIdeaById(nodeId), hasChildren = node && node.ideas && _3.size(node.ideas) > 0, rootCount = _3.size(idea.ideas), hasSiblings = idea.hasSiblings(nodeId), hasPreferredWidth = node && node.attr && node.attr.style && node.attr.style.width, hasPosition = node && node.attr && node.attr.position, isCollapsed = node && node.getAttr("collapsed"), isRoot = idea.isRootNode(nodeId);
          if (node) {
            return {
        ...
        self2.setIcon = function(source, url, imgWidth, imgHeight, position, nodeId, metaData) {
          ...
          if (url) {
            ...
            if (!nodeIdea.title && _3.size(nodeIdea.ideas) === 0) {
        ...
        self2.centerOnNode = function(nodeId) {
          if (!layoutModel.getNode(nodeId)) {
            idea.startBatch();
            _3.each(idea.calculatePath(nodeId), function(parent) {
        ...
        self2.search = function(query) {
          ...
          idea.traverse(function(contentIdea) {
            if (contentIdea.title && contentIdea.title.toLocaleLowerCase().indexOf(query) >= 0) {
              result2.push({ id: contentIdea.id, title: contentIdea.title });
            }
          });
          return result2;
        };
        (function() {
          ...
          self2.activateSiblingNodes = function(source) {
            const parent = idea.findParent(currentlySelectedIdeaId), siblingIds = parent && parent.ideas && _3.map(parent.ideas, function(child) {
              return child.id;
            });
          ...
          _3.each(["Left", "Right", "Up", "Down"], function(position) {
          ...
          self2.toggleActivationOnNode = function(source, nodeId) {
            ...
            if (!self2.isActivated(nodeId)) {
              ...
              setActiveNodes(_3.without(activatedNodes, nodeId));
            }
          };
          ...
          self2.activateChildren = function(source) {
            ...
            if (!context || _3.isEmpty(context.ideas) || context.getAttr("collapsed")) {
              return;
            }
          ...
          self2.isActivated = function(id) {
            return _3.find(activatedNodes, function(activeId) {
              return id == activeId;
            });
          };
          self2.applyToActivated = function(toApply) {
            idea.batch(function() {
              _3.each(activatedNodes, toApply);
            });
          };
          self2.everyActivatedIs = function(predicate) {
            return _3.every(activatedNodes, predicate);
          };
          self2.activateLevel = function(source, level) {
            const toActivate = _3.map(
              _3.filter(
                layoutModel.getLayout().nodes,
                function(node) {
            ...
            if (!_3.isEmpty(toActivate)) {
              setActiveNodes(toActivate);
            }
          };
          self2.reactivate = function(layout) {
            _3.each(layout.nodes, function(node) {
              if (_3.contains(activatedNodes, node.id)) {
                node.activated = true;
              }
            });
            return layout;
        ...
        self2.getNodeIdAtPosition = function(x, y) {
          ...
          }, node = _3.find(layoutModel.getLayout().nodes, isPointOverNode);
          return node && node.id;
        };
        ...
        self2.standardPositionNodeAt = function(nodeId, x, y, manualPosition) {
          ...
          const rootNode = layoutModel.getNode(layoutModel.getNode(nodeId).rootId), getVerticallyClosestNode = function() {
            ...
            _3.each(idea.sameSideSiblingIds(nodeId), function(id) {
              const node = layoutModel.getNode(id);
            ...
            if (_3.isEmpty(parentIdea.ideas)) {
              return 0;
            }
            return _3.max(_3.map(parentIdea.ideas, function(i) {
          ...
          if (thisNode && thisNode.level === 2) {
            result2 = tryFlip(rootNode, nodeBeingDragged, x);
          }
          if (!manualPosition && validReposition()) {
            self2.autoPosition(nodeId);
          }
          if (nodeBeingDragged.level > 1) {
            result2 = idea.positionBefore(nodeId, getVerticallyClosestNode().id) || result2;
          }
          if (manualPosition && validReposition()) {
            if (nodeBeingDragged.level === 1) {
              result2 = manuallyPositionRootNode();
            } else {
              result2 = manuallyPositionSubNode() || result2;
            }
          }
        ...
        self2.topDownPositionNodeAt = function(nodeId, x, y, manualPosition) {
          let result2, closestNodeToRight, closestNodeToLeft;
          ...
          _3.each(parentNode.ideas, function(sibling) {
          ...
          idea.batch(function() {
            ...
            result2 = idea.positionBefore(nodeId, closestNode && closestNode.id);
          });
          return result2;
        };
        ...
        self2.dropNode = function(nodeId, dropTargetId, shiftKey) {
          ...
          if (shiftKey) {
            clone2 = idea.clone(nodeId);
            if (clone2) {
              idea.paste(dropTargetId, clone2);
            }
            return false;
          }
        ...
        self2.getStandardReorderBoundary = function(nodeId) {
          const node = layoutModel.getNode(nodeId), nonRootStandardReorderBoundary = function(nodeId2) {
            ...
            const boundaries = [], node2 = layoutModel.getNode(nodeId2), rootNode = layoutModel.getNode(node2 && node2.rootId), isRightHalf = function(node3, rootNode2) {
              ...
              const tops = _3.map(siblings, function(node3) {
                return node3.y;
              }), bottoms = _3.map(siblings, function(node3) {
                return node3.y + node3.height;
              }), result2 = {
                "minY": _3.min(tops) - reorderMargin - node2.height,
                "maxY": _3.max(bottoms) + reorderMargin,
                "margin": reorderMargin
              };
              result2.edge = side;
              if (side === "left") {
                result2.x = parentNode.x + parentNode.width + reorderMargin;
              } else {
                result2.x = parentNode.x - reorderMargin;
              }
              return result2;
              ...
              return result2;
            }, sameSide = _3.map(idea.sameSideSiblingIds(nodeId2), function(id) {
              return layoutModel.getNode(id);
            }), otherSideSiblings = function() {
              let otherSide = _3.map(parentIdea.ideas, function(subIdea) {
                return layoutModel.getNode(subIdea.id);
              });
              otherSide = _3.without(otherSide, node2);
              if (!_3.isEmpty(sameSide)) {
                otherSide = _3.difference(otherSide, sameSide);
              }
              return otherSide;
            };
            if (!_3.isEmpty(sameSide)) {
        ...
        self2.getTopDownReorderBoundary = function(nodeId) {
          ...
          _3.each(parentNode.ideas, function(subIdea) {
        ...
        self2.makeSelectedNodeRoot = function() {
          ...
          if (isInputEnabled && isEditingEnabled) {
            return idea.batch(function() {
              ...
              const result2 = changeParent(nodeId, "root");
  ...
  var require_content_upgrade = __commonJS({
    "src/core/content/content-upgrade.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      module.exports = function contentUpgrade(content2) {
        ...
        const upgradeV2 = function() {
          ...
          const doUpgrade = function() {
            const rootAttrKeys = ["theme", "themeOverrides", "measurements-config", "storyboards", "progress-statuses"], oldRootAttr = content2 && content2.attr || {}, newRootAttr = _3.pick(oldRootAttr, rootAttrKeys), newRootNodeAttr = _3.omit(oldRootAttr, rootAttrKeys), firstLevel = content2 && content2.ideas, newRoot = {
              id: content2.id,
  ...
  var require_content = __commonJS({
    "src/core/content/content.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      var observable = require_observable();
      ...
      module.exports = function content2(contentAggregate, initialSessionId) {
        ...
        const invalidateIdCache = function() {
          ...
          return _3.reduce(
            idea.ideas,
            function(result2, subidea) {
              return Math.max(result2, maxId2(subidea));
            },
          ...
          if (contentIdea.ideas) {
            _3.each(contentIdea.ideas, function(value, key) {
              if (!initOfRoot && value.attr && value.attr.group && _3.isEmpty(value.ideas)) {
          ...
          contentIdea.findSubIdeaById = function(childIdeaId) {
            const myChild = _3.find(contentIdea.ideas, function(idea) {
              return idea.id == childIdeaId;
            });
            return myChild || _3.reduce(contentIdea.ideas, function(result2, idea) {
              return result2 || idea.findSubIdeaById(childIdeaId);
            }, void 0);
          };
          contentIdea.isEmptyGroup = function() {
            return !contentAggregate.isRootNode(contentIdea.id) && contentIdea.attr && contentIdea.attr.group && _3.isEmpty(contentIdea.ideas);
          };
          contentIdea.find = function(predicate) {
            const current = predicate(contentIdea) ? [_3.pick(contentIdea, "id", "title")] : [];
            if (_3.size(contentIdea.ideas) === 0) {
              return current;
            }
            return _3.reduce(contentIdea.ideas, function(result2, idea) {
              return _3.union(result2, idea.find(predicate));
            }, current);
          };
          contentIdea.getAttr = function(name) {
            if (contentIdea.attr && contentIdea.attr[name]) {
              return _3.clone(contentIdea.attr[name]);
            }
            return false;
          };
          contentIdea.sortedSubIdeas = function() {
            const result2 = [], childKeys = contentIdea.ideas && _3.groupBy(_3.map(_3.keys(contentIdea.ideas), parseFloat), function(key) {
              return key > 0;
            }), sortedChildKeys = childKeys && _3.sortBy(childKeys[true], Math.abs).concat(_3.sortBy(childKeys[false], Math.abs));
            if (!contentIdea.ideas) {
              return [];
            }
            _3.each(sortedChildKeys, function(key) {
              result2.push(contentIdea.ideas[key]);
            });
            return result2;
          };
          contentIdea.traverse = function(iterator, postOrder) {
            ...
            _3.each(contentIdea.sortedSubIdeas(), function(subIdea) {
          ...
          currentKeys = _3.keys(kvMap);
          currentKeys.push(0);
          return _3.max(_3.map(currentKeys, parseFloat), function(x) {
            return x * sign2;
          });
        }, isRootNode = function(id) {
          return !!_3.find(contentAggregate.ideas, function(idea) {
            return idea.id === id;
          });
        }, nextChildRank = function(parentIdea) {
          let newRank = 0, counts = 0, childRankSign = 1;
          if (isRootNode(parentIdea.id)) {
            counts = _3.countBy(parentIdea.ideas, function(v, k) {
              return k < 0;
            });
          ...
          return _3(_3.map(_3.keys(parentIdea.ideas), parseFloat)).reject(function(k) {
            return k * ideaRank < 0;
          });
        ...
        }) + (sessionKey || ""), updateAttr = function(object2, attrName, attrValue) {
          const oldAttr = object2 && _3.extend({}, object2.attr);
          if (!object2) {
            return false;
          }
          object2.attr = _3.extend({}, object2.attr);
          if (!attrValue || attrValue === "false" || _3.isObject(attrValue) && _3.isEmpty(attrValue)) {
            if (!object2.attr[attrName]) {
              return false;
            }
            delete object2.attr[attrName];
          } else {
            if (_3.isEqual(object2.attr[attrName], attrValue)) {
              return false;
            }
            object2.attr[attrName] = JSON.parse(JSON.stringify(attrValue));
          }
          if (_3.size(object2.attr) === 0) {
            delete object2.attr;
          }
          return function() {
            object2.attr = oldAttr;
          };
          ...
          const ideaFrom = findIdeaById(ideaIdFrom), ideaTo = findIdeaById(ideaIdTo), isParentChild = ideaFrom && ideaTo && (_3.find(ideaFrom.ideas, function(node) {
            return node.id === ideaIdTo;
          }) || _3.find(ideaTo.ideas, function(node) {
        ...
        contentAggregate.nextSiblingId = function(subIdeaId) {
          const parentIdea = contentAggregate.findParent(subIdeaId), currentRank = parentIdea && parentIdea.findChildRankById(subIdeaId), candidateSiblingRanks = currentRank && sameSideSiblingRanks(parentIdea, currentRank), siblingsAfter = candidateSiblingRanks && _3.reject(candidateSiblingRanks, function(k) {
          ...
          return parentIdea.ideas[_3.min(siblingsAfter, Math.abs)].id;
        };
        contentAggregate.sameSideSiblingIds = function(subIdeaId) {
          ...
          return _3.without(_3.map(_3.pick(parentIdea.ideas, sameSideSiblingRanks(parentIdea, currentRank)), function(i) {
            return i.id;
          }), subIdeaId);
        };
        ...
        contentAggregate.previousSiblingId = function(subIdeaId) {
          const parentIdea = contentAggregate.findParent(subIdeaId), currentRank = parentIdea && parentIdea.findChildRankById(subIdeaId), candidateSiblingRanks = currentRank && sameSideSiblingRanks(parentIdea, currentRank), siblingsBefore = candidateSiblingRanks && _3.reject(candidateSiblingRanks, function(k) {
            return Math.abs(k) >= Math.abs(currentRank);
          });
          if (!parentIdea) {
            return false;
          ...
          return parentIdea.ideas[_3.max(siblingsBefore, Math.abs)].id;
        };
        ...
        contentAggregate.cloneMultiple = function(subIdeaIdArray) {
          return _3.map(subIdeaIdArray, contentAggregate.clone);
        };
        contentAggregate.calculatePath = function(ideaId, currentPath, potentialParent) {
          ...
          return _3.reduce(
            ...
            function(result2, child) {
              return result2 || contentAggregate.calculatePath(ideaId, [child].concat(currentPath), child);
            },
            false
          );
        };
        contentAggregate.getSubTreeIds = function(rootIdeaId) {
          const result2 = [], collectIds = function(idea) {
            if (_3.isEmpty(idea.ideas)) {
              return [];
            }
            _3.each(idea.sortedSubIdeas(), function(child) {
              collectIds(child);
              result2.push(child.id);
            });
          };
        ...
        contentAggregate.findParent = function(subIdeaId, parentIdea) {
          ...
          return _3.reduce(
            parentIdea.ideas,
            function(result2, child) {
              return result2 || contentAggregate.findParent(subIdeaId, child);
            },
            false
          );
        };
        ...
        contentAggregate.endBatch = function(originSession) {
          const activeSession = originSession || sessionKey, inBatch = batches[activeSession], performBatchOperations = function() {
            const batchArgs = _3.map(inBatch, function(event) {
              return [event.eventMethod].concat(event.eventArgs);
            }), batchUndoFunctions = _3.sortBy(
              _3.map(inBatch, function(event) {
              ...
              _3.each(batchUndoFunctions, function(eventUndo) {
                eventUndo();
              });
            };
          ...
          batches[activeSession] = void 0;
          if (_3.isEmpty(inBatch)) {
            return;
          }
          if (_3.size(inBatch) === 1) {
        ...
        contentAggregate.execCommand = function(cmd, args, originSession) {
          ...
          return commandProcessors[cmd].apply(contentAggregate, [originSession || sessionKey].concat(_3.toArray(args)));
        };
        ...
        commandProcessors.batch = function(originSession) {
          ...
          try {
            _3.each(_3.toArray(arguments).slice(1), function(event) {
        ...
        contentAggregate.pasteMultiple = function(parentIdeaId, jsonArrayToPaste) {
          return contentAggregate.batch(function() {
            return _3.map(jsonArrayToPaste, function(json) {
        ...
        commandProcessors.paste = function(originSession, parentIdeaId, jsonToPaste, initialId) {
          const pasteParent = parentIdeaId == contentAggregate.id ? contentAggregate : contentAggregate.findSubIdeaById(parentIdeaId), cleanUp = function(json) {
            const result2 = _3.omit(json, "ideas", "id", "attr");
            let index = 1, childKeys, sortedChildKeys;
            result2.attr = _3.omit(json.attr, configuration.nonClonedAttributes);
            if (_3.isEmpty(result2.attr)) {
              delete result2.attr;
            }
            if (json.ideas) {
              childKeys = _3.groupBy(_3.map(_3.keys(json.ideas), parseFloat), function(key) {
                return key > 0;
              });
              sortedChildKeys = _3.sortBy(childKeys[true], Math.abs).concat(_3.sortBy(childKeys[false], Math.abs));
              result2.ideas = {};
              _3.each(sortedChildKeys, function(key) {
                result2.ideas[index++] = cleanUp(json.ideas[key]);
              });
            }
            return result2;
          };
        ...
        contentAggregate.removeMultiple = function(subIdeaIdArray) {
          let results = false;
          contentAggregate.startBatch();
          results = _3.map(subIdeaIdArray, contentAggregate.removeSubIdea);
          contentAggregate.endBatch();
          return results;
        };
        ...
        commandProcessors.removeSubIdea = function(originSession, subIdeaId) {
          const canRemove = function() {
            return !contentAggregate.isRootNode(subIdeaId) || _3.size(contentAggregate.ideas) > 1;
            ...
            contentAggregate.links = _3.reject(contentAggregate.links, function(link) {
        ...
        contentAggregate.insertIntermediateMultiple = function(idArray, ideaOptions) {
          return contentAggregate.batch(function() {
            ...
            _3.each(idArray.slice(1), function(id) {
        ...
        contentAggregate.getOrderedSiblingRanks = function(ideaId, options) {
          ...
          if (options && options.ignoreRankSide) {
            return _3.sortBy(_3.map(_3.keys(parentIdea.ideas), parseFloat));
          } else {
            return _3.sortBy(sameSideSiblingRanks(parentIdea, currentRank), Math.abs);
          }
        };
        contentAggregate.moveRelative = function(ideaId, relativeMovement, options) {
          ...
          result2 = contentAggregate.positionBefore(ideaId, beforeSibling && beforeSibling.id, parentIdea);
          contentAggregate.endBatch();
          return result2;
        };
        ...
        commandProcessors.positionBefore = function(originSession, ideaId, positionBeforeIdeaId, parentIdeaArg) {
          ...
          if (positionBeforeIdeaId) {
            ...
            candidateSiblings = _3.reject(_3.sortBy(siblingRanks, Math.abs), function(k) {
              return Math.abs(k) >= Math.abs(afterRank);
            });
            beforeRank = candidateSiblings.length > 0 ? _3.max(candidateSiblings, Math.abs) : 0;
          ...
          while (contentAggregate.links && i < contentAggregate.links.length) {
            ...
            if (link.ideaIdFrom === ideaIdOne && link.ideaIdTo === ideaIdTwo) {
              ...
              logChange("removeLink", [ideaIdOne, ideaIdTwo], function() {
                contentAggregate.links.push(_3.clone(link));
              }, originSession);
              return true;
            }
            i += 1;
        ...
        commandProcessors.storeResource = function(originSession, resourceBody, optionalKey) {
          const maxIdForSession = function() {
            const keys2 = _3.keys(contentAggregate.resources), filteredKeys = sessionKey ? _3.filter(keys2, RegExp.prototype.test.bind(new RegExp("\\/" + sessionKey + "$"))) : keys2, intKeys = _3.map(filteredKeys, function(string) {
              return parseInt(string, 10);
            });
            return _3.isEmpty(intKeys) ? 0 : _3.max(intKeys);
            ...
            if (!optionalKey && contentAggregate.resources) {
              return _3.find(_3.keys(contentAggregate.resources), function(key) {
        ...
        contentAggregate.hasSiblings = function(id) {
          ...
          return parent && _3.size(parent.ideas) > 1;
        };
        contentAggregate.isRootNode = function(id) {
          return isRootNode(id);
        };
        contentAggregate.getDefaultRootId = function() {
          const rootNodes = contentAggregate && _3.values(contentAggregate.ideas);
  ...
  // src/core/theme/default-theme.js
  var require_default_theme = __commonJS({
    "src/core/theme/default-theme.js"(exports, module) {
      module.exports = {
  ...
  var require_deep_freeze = __commonJS({
    "src/core/util/deep-freeze.js"(exports, module) {
  ...
  var require_theme_fallback_values = __commonJS({
    "src/core/theme/theme-fallback-values.js"(exports, module) {
  ...
  var require_theme_to_dictionary = __commonJS({
    "src/core/theme/theme-to-dictionary.js"(exports, module) {
  ...
  var require_is_object_object = __commonJS({
    "src/core/is-object-object.js"(exports, module) {
  ...
  var require_deep_assign = __commonJS({
    "src/core/deep-assign.js"(exports, module) {
  ...
  var require_color_to_rgb = __commonJS({
    "src/core/theme/color-to-rgb.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      ...
      var fromCSSRGB = function(colorString) {
        ...
        if (regCSSRGB.test(colorString)) {
          ...
          if (matched.length === 4) {
            return _3.map(matched.slice(1), function(i) {
              return parseInt(i);
            });
          }
        }
  ...
  var require_color_parser = __commonJS({
    "src/core/theme/color-parser.js"(exports, module) {
  ...
  var require_theme_attribute_utils = __commonJS({
    "src/core/theme/theme-attribute-utils.js"(exports, module) {
      ...
      var attributeForPath = function(object2, pathArray, fallback) {
        "use strict";
        if (!object2 || !pathArray || !pathArray.length) {
          return object2 === void 0 && fallback || object2;
        }
        if (pathArray.length === 1) {
          return object2[pathArray[0]] === void 0 && fallback || object2[pathArray[0]];
        }
        let remaining = pathArray.slice(0), current = object2;
      ...
      var nodeAttributeToNodeTheme = (nodeAttribute) => {
        ...
        }, result2 = deepAssign({}, themeFallbackValues.nodeTheme);
        if (nodeAttribute) {
          result2.margin = attributeForPath(nodeAttribute, ["text", "margin"], result2.margin);
          result2.font = deepAssign({}, result2.font, attributeForPath(nodeAttribute, ["text", "font"], result2.font));
          result2.text = deepAssign({}, result2.text, attributeForPath(nodeAttribute, ["text"], result2.text));
          result2.borderType = attributeForPath(nodeAttribute, ["border", "type"], result2.borderType);
          result2.backgroundColor = getBackgroundColor() || result2.backgroundColor;
          result2.cornerRadius = attributeForPath(nodeAttribute, ["cornerRadius"], result2.cornerRadius);
          result2.lineColor = attributeForPath(nodeAttribute, ["border", "line", "color"], result2.lineColor);
          result2.lineWidth = attributeForPath(nodeAttribute, ["border", "line", "width"], result2.lineWidth);
          result2.lineStyle = attributeForPath(nodeAttribute, ["border", "line", "style"], result2.lineStyle);
        }
        return result2;
      };
  ...
  var require_theme = __commonJS({
    "src/core/theme/theme.js"(exports, module) {
      ...
      module.exports = function Theme(themeJson) {
        ...
        self2.getFontForStyles = function(themeStyles) {
          const weight = attributeValue(["node"], themeStyles, ["text", "font", "weight"], "semibold"), size2 = attributeValue(["node"], themeStyles, ["text", "font", "size"], themeFallbackValues.nodeTheme.font.size), lineSpacing = attributeValue(["node"], themeStyles, ["text", "font", "lineSpacing"], themeFallbackValues.nodeTheme.font.lineSpacing);
          return { size: size2, weight, lineGap: lineSpacing };
        };
        ...
        self2.getLayoutConnectorAttributes = (styles) => {
          const childConnectorStyle = attributeValue(["node"], styles, ["connections", "style"], "default"), connectorDefaults = Object.assign({}, themeFallbackValues.connectorTheme), childConnector = themeAttributeUtils.attributeForPath(themeDictionary, ["connector", childConnectorStyle]) || connectorDefaults, result2 = {};
          if (childConnector && childConnector.line) {
            result2.parentConnector = {
        ...
        self2.getPersistedAttributes = (currentAttribs, nodeLevel, numberOfSiblings) => {
          ...
          }, childConnectorStyle = attributeValue(["node"], styles, ["connections", "style"], "default"), connectorDefaults = Object.assign({}, themeFallbackValues.connectorTheme), childConnector = themeAttributeUtils.attributeForPath(themeDictionary, ["connector", childConnectorStyle]) || connectorDefaults, autoColor = getAutoColor(), result2 = {
          ...
          if (childConnector && childConnector.line && childConnector.line.color === AUTO_COLOR) {
            result2.attr = Object.assign({
              parentConnector: {
                color: autoColor,
                themeAutoColor: autoColor
              }
            }, result2.attr);
          } else if (result2.attr.parentConnector && result2.attr.parentConnector.themeAutoColor) {
            result2.attr.parentConnector = Object.assign({}, result2.attr.parentConnector);
            if (result2.attr.parentConnector.themeAutoColor === result2.attr.parentConnector.color) {
              delete result2.attr.parentConnector.color;
            }
            delete result2.attr.parentConnector.themeAutoColor;
            if (!result2 || !result2.attr || !result2.attr.parentConnector || !Object.keys(result2.attr.parentConnector).length) {
              result2.removed.push("parentConnector");
              delete result2.attr.parentConnector;
            }
          }
          return result2;
        };
  ...
  var require_extract_connectors = __commonJS({
    "src/core/layout/extract-connectors.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      module.exports = function extractConnectors(aggregate, visibleNodes, theme) {
        "use strict";
        const result2 = {}, allowParentConnectorOverride = !(theme && (theme.connectorEditingContext || theme.blockParentConnectorOverride)), traverse = function(idea, parentId, isChildNode) {
          if (isChildNode) {
            ...
            if (parentId !== aggregate.id) {
              ...
              if (visibleNode.attr && visibleNode.attr.parentConnector) {
                if (allowParentConnectorOverride && visibleNode.attr && visibleNode.attr.parentConnector) {
                  result2[idea.id].attr = _3.clone(visibleNode.attr.parentConnector);
                  ...
                  result2[idea.id].connectorEditingContext = theme.connectorEditingContext;
                  result2[idea.id].attr = _3.pick(visibleNode.attr.parentConnector, theme.connectorEditingContext.allowed);
                }
              }
            }
          }
      ...
      function BuildLog() {
        ...
        my = {
          ...
          checkIntersection: function(seg1, seg2) {
            return push2("check", { seg1, seg2 });
          },
          segmentChop: function(seg, end) {
            push2("div_seg", { seg, pt: end });
            return push2("chop", { seg, pt: end });
          },
          statusRemove: function(seg) {
            return push2("pop_seg", { seg });
          },
          segmentUpdate: function(seg) {
            return push2("seg_update", { seg });
          },
          segmentNew: function(seg, primary) {
            return push2("new_seg", { seg, primary });
          },
          segmentRemove: function(seg) {
            return push2("rem_seg", { seg });
          },
          tempStatus: function(seg, above, below) {
            return push2("temp_status", { seg, above, below });
          },
          rewind: function(seg) {
            return push2("rewind", { seg });
          },
          status: function(seg, above, below) {
            return push2("status", { seg, above, below });
          },
          vert: function(x) {
            if (x === curVert)
              return my;
          ...
          log: function(data) {
            ...
            return push2("log", { txt: data });
          },
          reset: function() {
            return push2("reset");
          },
          selected: function(segs) {
            return push2("selected", { segs });
          },
          chainStart: function(seg) {
            return push2("chain_start", { seg });
          },
          chainRemoveHead: function(index, pt) {
            return push2("chain_rem_head", { index, pt });
          },
          chainRemoveTail: function(index, pt) {
            return push2("chain_rem_tail", { index, pt });
          },
          chainNew: function(pt1, pt2) {
            return push2("chain_new", { pt1, pt2 });
          },
          chainMatch: function(index) {
            return push2("chain_match", { index });
          },
          chainClose: function(index) {
            return push2("chain_close", { index });
          },
          chainAddHead: function(index, pt) {
            return push2("chain_add_head", { index, pt });
          },
          chainAddTail: function(index, pt) {
            return push2("chain_add_tail", { index, pt });
          },
          chainConnect: function(index1, index2) {
            return push2("chain_con", { index1, index2 });
          },
          chainReverse: function(index) {
            return push2("chain_rev", { index });
          },
          chainJoin: function(index1, index2) {
            return push2("chain_join", { index1, index2 });
          },
          done: function() {
            return push2("done");
          }
      ...
      function SegmentChainer(segments, eps, buildLog) {
        ...
        segments.forEach(function(seg) {
          ...
          for (var i = 0; i < chains.length; i++) {
            ...
            var head = chain2[0];
            var head2 = chain2[1];
            var tail = chain2[chain2.length - 1];
            var tail2 = chain2[chain2.length - 2];
          ...
          if (next_match === second_match) {
            ...
            var chain2 = chains[index];
            var grow = addToHead ? chain2[0] : chain2[chain2.length - 1];
            var grow2 = addToHead ? chain2[1] : chain2[chain2.length - 2];
            var oppo = addToHead ? chain2[chain2.length - 1] : chain2[0];
            var oppo2 = addToHead ? chain2[chain2.length - 2] : chain2[1];
          ...
          function appendChain(index1, index2) {
            ...
            chains[index1] = chain1.concat(chain22);
    ...
    "node_modules/polybooljs/lib/geojson.js"(exports, module) {
      var GeoJSON = {
        ...
        fromPolygon: function(PolyBool, eps, poly) {
          ...
          function addChild(root2, region2) {
            for (var i2 = 0; i2 < root2.children.length; i2++) {
              var child = root2.children[i2];
  ...
  var require_two_product = __commonJS({
    "node_modules/two-product/two-product.js"(exports, module) {
      ...
      function twoProduct(a, b, result2) {
        var x = a * b;
        var c = SPLITTER * a;
        var abig = c - a;
        var ahi = c - abig;
  ...
  var require_two_sum = __commonJS({
    "node_modules/two-sum/two-sum.js"(exports, module) {
      ...
      function fastTwoSum(a, b, result2) {
        var x = a + b;
        var bv = x - a;
        var av = x - bv;
        var br = b - bv;
  ...
  var require_monotone_convex_hull_2d = __commonJS({
    "node_modules/monotone-convex-hull-2d/index.js"(exports, module) {
      ...
      function monotoneConvexHull2D(points) {
        ...
        var result2 = new Array(upper.length + lower.length - 2);
        var ptr = 0;
  ...
  // src/core/layout/layout-geometry.js
  var require_layout_geometry = __commonJS({
    "src/core/layout/layout-geometry.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      ...
      var areShapesEqual = function(shape1, shape2) {
        ...
        return _3.filter(shape1, function(p1) {
          return _3.filter(shape2, function(p2) {
      ...
      var polygonsAreEqual = function(poly1, poly2) {
        ...
        const matchingShapes = function() {
          return _3.filter(poly1, function(shape1) {
            return _3.filter(poly2, function(shape2) {
      ...
      var shapeContainingIntersection = function(poly, intersection2) {
        "use strict";
        const pbIntersection = toPolyBoolPoly(intersection2), containingShape = _3.find(poly, function(shape) {
          const pbShape = toPolyBoolPoly([shape]), shapeIntersection = PolyBool.intersect(pbIntersection, pbShape);
          return polygonsAreEqual(intersection2, shapeIntersection.regions);
        });
        return containingShape && containingShape.length && containingShape;
      };
      var polygonIntersectionPoints = function(poly1, poly2) {
        "use strict";
        const pbPoly1 = toPolyBoolPoly(poly1), pbPoly2 = toPolyBoolPoly(poly2), intersection2 = PolyBool.intersect(pbPoly1, pbPoly2), isSameAsPoly1 = polygonsAreEqual(poly1, intersection2.regions), isContained = isSameAsPoly1 && !polygonsAreEqual(intersection2.regions, poly2), containingShape = isContained && shapeContainingIntersection(poly2, intersection2.regions);
        if (containingShape) {
          return containingShape;
        }
        return _3.flatten(intersection2.regions, true);
      };
      ...
      var orderPointsOnVector = function(points, vectorOrigin, vector, pointsBeforeOriginOnly) {
        ...
        const pointScale = function(point) {
          ...
          return vectorScale;
        }, filteredPoints = _3.filter(points, function(point) {
          if (pointsBeforeOriginOnly) {
            return pointScale(point) < 0;
          }
          return pointScale(point) >= 0;
        });
        return _3.sortBy(filteredPoints, pointScale);
      };
      var buildPoints = function(layout, margin) {
        "use strict";
        const points = [];
        _3.each(layout, function(node) {
      ...
      var tolayoutPolygonHull = function(layout, margin) {
        "use strict";
        const points = buildPoints(layout, margin), hullIndices = convexHull(points), hull = _3.map(hullIndices, function(hullIndex) {
      ...
      var firstProjectedPolyPointOnVector = function(poly, vectorOrigin, vector) {
        "use strict";
        const polyPoints = _3.flatten(poly, true), intersectionsOnLine = polyPoints.map(function(intersection2) {
          return projectPointOnLineVector(intersection2, vectorOrigin, vector);
      ...
      var furthestIntersectionPoint = function(poly1, poly2, vectorOrigin, vector) {
        "use strict";
        const intersections = polygonIntersectionPoints(poly1, poly2), intersectionsOnLine = intersections.map(function(intersection2) {
          return projectPointOnLineVector(intersection2, vectorOrigin, vector);
  ...
  // src/core/layout/multi-root-layout.js
  var require_multi_root_layout = __commonJS({
    "src/core/layout/multi-root-layout.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      ...
      module.exports = function MultiRootLayout() {
        ...
        const self2 = this, mergeNodes = function(storedLayout, offset) {
          _3.each(storedLayout.rootLayout, function(node) {
          ...
          return positionedLayouts.length && _3.max(positionedLayouts, function(layout) {
        ...
        self2.getCombinedLayout = function(margin, optional) {
          ...
          const origin = { x: 0, y: 0 }, contextNode = optional && optional.contextNode, contextLayout = contextNode && positionedLayouts.find((layout) => layout.rootLayout[contextNode]), firstToPlace = contextLayout || getMostRecentlyPositionedLayout(), rootDistance = function(storedLayout) {
            ...
            if (!storedLayout || _3.contains(placedLayouts, storedLayout)) {
              return;
            }
          ...
          placedLayouts.forEach(function(placedLayout) {
            result2 = _3.extend(result2, placedLayout.rootLayout);
          });
          return result2;
        };
      };
  ...
  var require_object_utils = __commonJS({
    "src/core/util/object-utils.js"(exports, module) {
  ...
  var require_node_attribute_utils = __commonJS({
    "src/core/layout/node-attribute-utils.js"(exports, module) {
      ...
      var setThemeAttributes = function(nodes, theme) {
        ...
        Object.keys(nodes).forEach(function(nodeKey) {
          ...
          node.attr = _3.extend({}, theme.getLayoutConnectorAttributes(node.styles), node.attr);
        });
        Object.keys(nodes).forEach(function(nodeKey) {
          const node = nodes[nodeKey];
  ...
  var require_is_empty_group = __commonJS({
    "src/core/content/is-empty-group.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      module.exports = function isEmptyGroup(contentIdea) {
        "use strict";
        return contentIdea.attr && contentIdea.attr.group && _3.isEmpty(contentIdea.ideas);
      };
    }
  });

  // src/core/layout/standard/outline.js
  var require_outline = __commonJS({
    "src/core/layout/standard/outline.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      var borderLength = function(border) {
        "use strict";
        return _3.reduce(border, function(seed, el) {
          return seed + el.l;
        }, 0);
      };
      ...
      var extendBorder = function(originalBorder, extension) {
        "use strict";
        let lengthToCut, result2 = originalBorder.slice();
        ...
        if (i >= 0) {
          ...
          result2.push({ h: extension[i].h, l: lengthToCut - origLength });
          result2 = result2.concat(extension.slice(i + 1));
        }
        return result2;
      };
      var Outline = function(topBorder, bottomBorder) {
        ...
        const shiftBorder = function(border, deltaH) {
          return _3.map(border, function(segment) {
            return {
              l: segment.l,
              h: segment.h + deltaH
            };
        ...
        this.borders = function() {
          return _3.pick(this, "top", "bottom");
        };
        this.spacingAbove = function(outline) {
          let i = 0, j = 0, result2 = 0, li = 0, lj = 0;
          while (i < this.bottom.length && j < outline.top.length) {
            result2 = Math.max(result2, this.bottom[i].h - outline.top[j].h);
  ...
  // src/core/layout/standard/tree.js
  var require_tree = __commonJS({
    "src/core/layout/standard/tree.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      var isEmptyGroup = require_is_empty_group();
      var outlineUtils = require_outline();
      var Tree = function(options) {
        "use strict";
        _3.extend(this, options);
        this.toLayout = function(x, y, parentId) {
          const result2 = {
            nodes: {},
            connectors: {}
          }, self2 = _3.pick(this, "id", "title", "attr", "width", "textWidth", "height", "level");
          if (parentId) {
          ...
          result2.nodes[this.id] = self2;
          if (parentId !== void 0) {
            result2.connectors[self2.id] = {
              from: parentId,
              to: self2.id
            };
          }
          if (this.subtrees) {
            this.subtrees.forEach(function(t) {
              ...
              _3.extend(result2.nodes, subLayout.nodes);
              _3.extend(result2.connectors, subLayout.connectors);
            });
          }
          return result2;
        };
      ...
      var calculateTree = function(content2, dimensionProvider, margin, rankAndParentPredicate, level) {
        ...
        const options = {
          ...
          const oldPositions = _3.map(treeArray, function(t) {
            return _3.pick(t, "deltaX", "deltaY");
          ...
          return !(_3.isEmpty(content2.ideas) || content2.attr && content2.attr.collapsed);
        }, includedSubIdeaKeys = function() {
          const allRanks = _3.map(_3.keys(content2.ideas), parseFloat), candidateRanks = rankAndParentPredicate ? _3.filter(allRanks, function(rank) {
            return rankAndParentPredicate(rank, content2.id);
          }) : allRanks, includedRanks = _3.filter(candidateRanks, function(rank) {
            return !isEmptyGroup(content2.ideas[rank]);
          });
          return _3.sortBy(includedRanks, Math.abs);
        }, includedSubIdeas = function() {
          const result2 = [];
          _3.each(includedSubIdeaKeys(), function(key) {
            result2.push(content2.ideas[key]);
          });
          return result2;
          ...
          _3.each(subtrees, function(subtree) {
  ...
  var require_calculate_standard_layout = __commonJS({
    "src/core/layout/standard/calculate-standard-layout.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      ...
      module.exports = function calculateStandardLayout(idea, dimensionProvider, margin) {
        ...
        _3.each(negativeLayout.nodes, function(n) {
          n.x = -1 * n.x - n.width;
        });
        return _3.extend(negativeLayout.nodes, layout.nodes);
      };
    }
  });
  ...
  var require_compacted_group_width = __commonJS({
    "src/core/layout/top-down/compacted-group-width.js"(exports, module) {
  ...
  var require_sort_nodes_by_left_position = __commonJS({
    "src/core/layout/top-down/sort-nodes-by-left-position.js"(exports, module) {
  ...
  var require_align_group = __commonJS({
    "src/core/layout/top-down/align-group.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      var compactedGroupWidth = require_compacted_group_width();
      var sortNodesByLeftPosition = require_sort_nodes_by_left_position();
      module.exports = function alignGroup(result2, rootIdea, margin) {
        "use strict";
        if (!margin) {
          throw "invalid-args";
        }
        const nodes = result2.nodes, rootNode = nodes[rootIdea.id], childIds = _3.values(rootIdea.ideas).map(function(idea) {
          return idea.id;
        ...
        }, sameLevelNodes = _3.values(nodes).filter(function(node) {
  ...
  var require_vertical_subtree_collection = __commonJS({
    "src/core/layout/top-down/vertical-subtree-collection.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      module.exports = function VerticalSubtreeCollection(subtreeMap, marginArg) {
        ...
        self2.getLevelWidths = function() {
          const result2 = [], maxLevel = _3.max(_3.map(subtreeMap, function(childLayout) {
            return childLayout.levels.length;
          }));
          for (let levelIdx = 0; levelIdx < maxLevel; levelIdx++) {
            result2.push(self2.getLevelWidth(levelIdx));
          }
          return result2;
        };
        self2.isEmpty = function() {
          return _3.isEmpty(subtreeMap);
        };
  ...
  var require_combine_vertical_subtrees = __commonJS({
    "src/core/layout/top-down/combine-vertical-subtrees.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      ...
      module.exports = function combineVerticalSubtrees(node, childLayouts, margin, sameLevel) {
        ...
        result2.nodes[node.id] = node;
        node.x = Math.round(-0.5 * node.width);
        result2.levels = [{ width: node.width, xOffset: node.x }];
        if (!verticalSubtreeCollection.isEmpty()) {
          if (sameLevel) {
            result2.levels = verticalSubtreeCollection.getMergedLevels();
            treeOffset = result2.levels[0].xOffset;
          } else {
            result2.levels = result2.levels.concat(verticalSubtreeCollection.getMergedLevels());
            treeOffset = result2.levels[1].xOffset;
          }
          Object.keys(childLayouts).forEach(function(subtreeRank) {
            _3.extend(result2.nodes, shift(childLayouts[subtreeRank].nodes, treeOffset + verticalSubtreeCollection.getExpectedTranslation(subtreeRank)));
          });
        }
        return result2;
      };
  ...
  var require_calculate_top_down_layout = __commonJS({
    "src/core/layout/top-down/calculate-top-down-layout.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      var isEmptyGroup = require_is_empty_group();
      ...
      module.exports = function calculateTopDownLayout(aggregate, dimensionProvider, margin) {
        ...
        const isGroup = function(node) {
          ...
          const dimensions = dimensionProvider(idea, level), node = _3.extend({ level, verticalOffset: 0, title: isGroup(idea) ? "" : idea.title }, dimensions, _3.pick(idea, ["id", "attr"]));
          if (parentId) {
            node.parentId = parentId;
          }
          return node;
        }, traverse = function(idea, predicate, level, parentId) {
          const childResults = {}, shouldIncludeSubIdeas = !(_3.isEmpty(idea.ideas) || idea.attr && idea.attr.collapsed);
          level = level || 1;
          if (shouldIncludeSubIdeas) {
            Object.keys(idea.ideas).forEach(function(subNodeRank) {
              const newLevel = isGroup(idea) ? level : level + 1, result2 = traverse(idea.ideas[subNodeRank], predicate, newLevel, idea.id);
              if (result2) {
                childResults[subNodeRank] = result2;
              }
            });
          }
          ...
          let result2;
          if (isGroup(node) && !_3.isEmpty(idea.ideas)) {
            result2 = combineVerticalSubtrees(node, childLayouts, margin.h, true);
            alignGroup(result2, idea, margin.h);
          } else {
            result2 = combineVerticalSubtrees(node, childLayouts, margin.h);
          }
          return result2;
  ...
  var require_calculate_layout = __commonJS({
    "src/core/layout/calculate-layout.js"(exports, module) {
      var contentUpgrade = require_content_upgrade();
      ...
      var formatResult = function(result2, idea, theme, orientation) {
        "use strict";
        nodeAttributeUtils.setThemeAttributes(result2, theme);
        return {
          orientation,
          nodes: result2,
          connectors: extractConnectors(idea, result2, theme),
          links: extractLinks(idea, result2),
  ...
  var require_node_cache_mark = __commonJS({
    "src/browser/node-cache-mark.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      module.exports = function nodeCacheMark(idea, optional) {
        ...
        return {
          ...
          icon: idea.attr && idea.attr.icon && _3.pick(idea.attr.icon, "width", "height", "position"),
  ...
  var require_clean_dom_id = __commonJS({
    "src/core/util/clean-dom-id.js"(exports, module) {
  ...
  var require_node_key = __commonJS({
    "src/core/util/node-key.js"(exports, module) {
    ...
    "node_modules/jquery-hammerjs/jquery.hammer-full.js"(exports, module) {
      (function(window2, undefined2) {
        ...
        var Utils = Hammer.utils = {
           ...
           */
          each: function each2(obj, iterator, context) {
            var i, len;
            if ("forEach" in obj) {
           ...
           */
          inStr: function inStr(src, find2) {
            return src.indexOf(find2) > -1;
          },
          /**
           ...
           */
          inArray: function inArray(src, find2) {
            if (src.indexOf) {
              var index = src.indexOf(find2);
          ...
          getCenter: function getCenter(touches) {
            var pageX = [], pageY = [], clientX = [], clientY = [], min2 = Math.min, max2 = Math.max;
            if (touches.length === 1) {
              return {
            ...
            return {
              pageX: (min2.apply(Math, pageX) + max2.apply(Math, pageX)) / 2,
              pageY: (min2.apply(Math, pageY) + max2.apply(Math, pageY)) / 2,
              clientX: (min2.apply(Math, clientX) + max2.apply(Math, clientX)) / 2,
              clientY: (min2.apply(Math, clientY) + max2.apply(Math, clientY)) / 2
            };
          },
          /**
  ...
  // test/esbuild-shims/jquery-hammer-shim.js
  var require_jquery_hammer_shim = __commonJS({
    "test/esbuild-shims/jquery-hammer-shim.js"(exports, module) {
      window.jQuery = window.jQuery || require_jquery();
  ...
  // src/browser/hammer-draggable.js
    ...
    "src/browser/hammer-draggable.js"() {
      ...
      $.fn.simpleDraggableContainer = function() {
        ...
        return this.on("mm:start-dragging", function(event) {
          ...
          const target = $(event.relatedTarget), clone2 = function() {
            const result2 = target.clone().addClass("drag-shadow").appendTo(container).offset(target.offset()).data(target.data()).attr("mapjs-drag-role", "shadow"), scale = target.parent().data("scale") || 1;
            if (scale !== 0) {
              result2.css({
  ...
  var require_line_strokes = __commonJS({
    "src/core/theme/line-strokes.js"(exports, module) {
      module.exports = {
        dashed: "8, 8",
        solid: ""
      };
  ...
  var require_convert_position_to_transform = __commonJS({
    "src/core/util/convert-position-to-transform.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      module.exports = function convertPositionToTransform(cssPosition) {
        "use strict";
        const position = _3.omit(cssPosition, "left", "top");
  ...
  var require_update_connector_text = __commonJS({
    "src/browser/update-connector-text.js"(exports, module) {
      var createSVG = require_create_svg();
  ...
  var require_calc_label_center_point = __commonJS({
    "src/browser/calc-label-center-point.js"(exports, module) {
      var defaultTheme = require_default_theme();
      var createSVG = require_create_svg();
  ...
  var require_calc_child_position = __commonJS({
    "src/core/theme/calc-child-position.js"(exports, module) {
  ...
  // src/core/theme/line-types.js
  var require_line_types = __commonJS({
    "src/core/theme/line-types.js"(exports, module) {
      ...
      module.exports = {
        ...
        "vertical-quadratic-s-curve": function(calculatedConnector, position) {
          "use strict";
          const dx = Math.round(calculatedConnector.to.x - calculatedConnector.from.x), dy = Math.round(calculatedConnector.to.y - calculatedConnector.from.y), dxIncrement = dx / 2, dyIncrement = dy / 2;
          if (Math.abs(dx) < 20) {
            return {
  ...
  var require_node_connection_point_x = __commonJS({
    "src/core/theme/node-connection-point-x.js"(exports, module) {
  ...
  // src/core/theme/connector.js
  var require_connector = __commonJS({
    "src/core/theme/connector.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      var Theme = require_theme();
      ...
      var appendOverLine = function(connectorCurve, calculatedConnector) {
        "use strict";
        const initialRadius = connectorCurve.initialRadius || 0, halfWidth = calculatedConnector.nodeOverline && Math.floor(0.5 * Math.abs(calculatedConnector.nodeOverline.to.x - calculatedConnector.nodeOverline.from.x)) - 1;
      ...
      var calculateConnector = function(parent, child, theme) {
        "use strict";
        const childPosition = calcChildPosition(parent, child, 10), fromStyles = parent.styles, toStyles = child.styles, connectionPositionDefaultFrom = theme.attributeValue(["node"], fromStyles, ["connections", "default"], { h: "center", v: "center" }), connectionPositionDefaultTo = theme.attributeValue(["node"], toStyles, ["connections", "default"], { h: "nearest-inset", v: "center" }), connectionPositionFrom = _3.extend({}, connectionPositionDefaultFrom, theme.attributeValue(["node"], fromStyles, ["connections", "from", childPosition], {})), connectionPositionTo = _3.extend({}, connectionPositionDefaultTo, theme.attributeValue(["node"], toStyles, ["connections", "to"], {})), connectorTheme = theme.connectorTheme(childPosition, toStyles, fromStyles), fromInset = theme.attributeValue(["node"], fromStyles, ["cornerRadius"], 10), toInset = theme.attributeValue(["node"], toStyles, ["cornerRadius"], 10), borderType = theme.attributeValue(["node"], toStyles, ["border", "type"], "");
      ...
      var themePath = function(parent, child, themeArg) {
        ...
        }, theme = themeArg || new Theme({}), calculatedConnector = calculateConnector(parent, child, theme), result2 = appendBorderLines(lineTypes[calculatedConnector.connectorTheme.type](calculatedConnector, position, parent, child), calculatedConnector, position);
        result2.color = calculatedConnector.connectorTheme.line.color;
        result2.width = calculatedConnector.connectorTheme.line.width;
        result2.theme = calculatedConnector.connectorTheme;
        return result2;
      };
  ...
  var require_build_connection = __commonJS({
    "src/browser/build-connection.js"(exports, module) {
  ...
  var require_line_styles = __commonJS({
    "src/core/theme/line-styles.js"(exports, module) {
      module.exports = {
        strokes: (name, width) => {
          "use strict";
          if (!name || name === "solid") {
  ...
  // src/core/theme/link.js
  var require_link = __commonJS({
    "src/core/theme/link.js"(exports, module) {
      var Theme = require_theme();
      ...
      var linkPath = function(parent, child, linkAttrArg, themeArg) {
        ...
        const calculateConnector = function(parent2, child2) {
          ...
          let i, j, min2 = Infinity, bestParent, bestChild, dx, dy, current;
  ...
  var require_url_helper = __commonJS({
    "src/core/util/url-helper.js"(exports, module) {
  ...
  var require_formatted_node_title = __commonJS({
    "src/core/content/formatted-node-title.js"(exports, module) {
  ...
  var require_foreground_style = __commonJS({
    "src/core/theme/foreground-style.js"(exports, module) {
      var convertToRGB = require_color_to_rgb();
  ...
  var require_apply_idea_attributes_to_node_theme = __commonJS({
    "src/core/content/apply-idea-attributes-to-node-theme.js"(exports, module) {
  ...
  var require_calc_max_width = __commonJS({
    "src/core/util/calc-max-width.js"(exports, module) {
    ...
    "src/browser/set-theme-class-list.js"() {
      ...
      jQuery3.fn.setThemeClassList = function(classList) {
        ...
        const domElement = this[0], filterClasses = function(classes) {
          return _3.filter(classes, function(c) {
  ...
  // src/browser/update-node-content.js
  var require_update_node_content = __commonJS({
    "src/browser/update-node-content.js"() {
      ...
      jQuery3.fn.updateNodeContent = function(nodeContent, theme, optional) {
        ...
        let offset;
        nodeCacheData.innerRect = _3.pick(nodeCacheData, ["width", "height"]);
    ...
    "src/browser/update-stage.js"() {
      ...
      jQuery3.fn.updateStage = function() {
        ...
        if (data.scale && data.scale !== 1) {
          size2.transform = "scale(" + data.scale + ") translate(" + Math.round(data.offsetX) + "px, " + Math.round(data.offsetY) + "px)";
        }
        this.css(size2);
        if (svgContainer) {
  ...
  var require_place_caret_at_end = __commonJS({
    "src/browser/place-caret-at-end.js"() {
      ...
      jQuery3.fn.placeCaretAtEnd = function() {
        ...
        const el = this[0], range2 = document.createRange(), sel = window.getSelection();
      ...
      jQuery3.fn.editNode = function(shouldSelectAll) {
        ...
        return new Promise((resolve, reject2) => {
          const clear = function() {
            ...
            const content2 = textBox.innerText();
  ...
  var require_connector_key = __commonJS({
    "src/core/util/connector-key.js"(exports, module) {
      var cleanDOMId = require_clean_dom_id();
  ...
  var require_link_key = __commonJS({
    "src/core/util/link-key.js"(exports, module) {
      var cleanDOMId = require_clean_dom_id();
  ...
  var require_create_reorder_bounds = __commonJS({
    "src/browser/create-reorder-bounds.js"() {
      ...
      jQuery3.fn.createReorderBounds = function() {
        "use strict";
        const result2 = jQuery3("<div>").attr({
  ...
  // src/browser/dom-map-controller.js
  var require_dom_map_controller = __commonJS({
    "src/browser/dom-map-controller.js"(exports, module) {
      var jQuery3 = require_jquery();
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      ...
      module.exports = function DomMapController(mapModel, stageElement, touchEnabled, resourceTranslator, themeSource, options) {
        ...
        const self2 = this, viewPort = stageElement.parent(), viewPortAnimOptions = { duration: 400 }, reorderBounds = mapModel.isEditingEnabled() ? stageElement.createReorderBounds() : jQuery3("<div>"), svgPixel = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="1" height="1"></svg>', dummyTextBox = jQuery3("<div>").addClass("mapjs-node").addClass("noTransition").css({ position: "absolute", visibility: "hidden" }), getViewPortDimensions = function() {
          ...
          if (dropPosition) {
            ...
            if (result2.x >= 0 && result2.x <= viewPort.innerWidth() && result2.y >= 0 && result2.y <= viewPort.innerHeight()) {
              return result2;
            }
          }
          ...
          if (_3.isEmpty(boundaries)) {
            return false;
          }
          if (!box) {
            return false;
          }
          return _3.find(boundaries, closeTo);
        ...
        self2.dimensionProvider = function(idea, level) {
          let result2 = false, textBox = stageElement.nodeWithId(idea.id);
          const expectedCacheMark = nodeCacheMark(idea, { level, theme: themeSource() });
          if (textBox && textBox.length > 0) {
            if (_3.isEqual(textBox.data("nodeCacheMark"), expectedCacheMark)) {
              record("dimension-cache:hit");
              return _3.pick(textBox.data(), "width", "height", "textWidth");
            }
          }
          ...
          textBox.appendTo("body").updateNodeContent(
            idea,
            themeSource(),
            { resourceTranslator: translateToPixel, level, decorations: ["left", "right"] }
          );
          result2 = {
        ...
        mapModel.addEventListener("activatedNodesChanged", function(activatedNodes, deactivatedNodes) {
          _3.each(activatedNodes, function(nodeId) {
            stageElement.nodeWithId(nodeId).addClass("activated");
          });
          _3.each(deactivatedNodes, function(nodeId) {
  ...
  // src/core/theme/theme-processor.js
  var require_theme_processor = __commonJS({
    "src/core/theme/theme-processor.js"(exports, module) {
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      var colorParser = require_color_parser();
      module.exports = function ThemeProcessor() {
        ...
        const self2 = this, addPx = function(val) {
          ...
          let parser, cssVal;
          const result2 = [], pushProperties = function(styleObject, keyPrefix) {
            _3.each(styleObject, function(val, propKey) {
              const key = (keyPrefix || "") + propKey;
              if (cssProp[key]) {
                parser = parsers[key] || _3.identity;
                cssVal = parser(val);
                if (cssVal) {
                  result2.push(cssProp[key]);
                  result2.push(":");
                  result2.push(cssVal);
                  result2.push(";");
                }
              } else if (_3.isObject(val)) {
            ...
            result2.push(styleSelector);
            result2.push(" span {");
            result2.push("max-width:");
            result2.push(maxWidth);
            result2.push("px;}");
            ...
            result2.push(styleSelector);
            result2.push(" .mapjs-decorations{position:absolute;");
            result2.push(`font-size:${fontSize}pt;`);
            if (style.edge === "top" || style.edge === "bottom") {
              if (style.position === "end") {
                ...
                result2.push("left:0;width:100%;text-align:center;");
              }
              result2.push(style.edge);
              result2.push(":-");
              result2.push(style.overlap ? Math.round(style.height / 2) + margin : style.height);
              result2.push("px;");
            } else if (style.edge === "left" || style.edge === "right") {
              result2.push(style.edge === "left" ? "right" : "left");
              result2.push(":100%;");
              if (style.position === "end") {
                result2.push("bottom:0;");
              } else if (style.position === "start") {
                result2.push("top:0;");
              } else {
                result2.push("top:calc(50% - ");
                result2.push(Math.round(style.height / 2));
                result2.push("px);");
              }
            }
            result2.push("}");
  ...
  var require_format_note_to_html = __commonJS({
    "src/core/content/format-note-to-html.js"(exports, module) {
      var URLHelper = require_url_helper();
      var _3 = (init_index_all(), __toCommonJS(index_all_exports));
      module.exports = function formatNoteToHtml(noteText) {
        ...
        const safeString = _3.escape(noteText);
  ...
  var require_npm_main = __commonJS({
    "src/npm-main.js"(exports, module) {
  ...
  // test/theme-argmap.js
  var require_theme_argmap = __commonJS({
    "test/theme-argmap.js"(exports, module) {
      var MAPJS2 = MAPJS2 || {};
      MAPJS2.Themes = MAPJS2.Themes || {};
      MAPJS2.Themes.argumentMapping = {
      ...
      module.exports = { default: MAPJS2.Themes.argumentMapping };
    }
  });

  // test/example-map.json
  var require_example_map = __commonJS({
    "test/example-map.json"(exports, module) {
  ...
  var themeProvider = require_theme_argmap();
  var testMap = require_example_map();
  var content = MAPJS.content;
  var init = function() {
    "use strict";
    let domMapController = false;
    const container = jQuery2("#container"), idea = content(testMap), touchEnabled = false, mapModel = new MAPJS.MapModel([]), layoutThemeStyle = function(themeJson2) {
      const themeCSS = themeJson2 && new MAPJS.ThemeProcessor().process(themeJson2).css;
      if (!themeCSS) {
        return false;
      }
      if (!window.themeCSS) {
        jQuery2('<style id="themeCSS" type="text/css"></style>').appendTo("head").text(themeCSS);
      }
      return true;
    }, themeJson = themeProvider.default || MAPJS.defaultTheme, theme = new MAPJS.Theme(themeJson), getTheme = () => theme;
